...
public abstract class CurveFsProto {
    ...
    public abstract Dirent[] listdir(String path) throws IOException;

    public abstract void create(String path, int mode, File file) throws IOException;
    public abstract void open(String path, int flags, File file) throws IOException;
    public abstract long lseek(int fd, long offset, int whence) throws IOException;
    public abstract int write(int fd, long offset, byte[] buffer, long size) throws IOException;
    public abstract int read(int fd, long offset, byte[] buffer, long size) throws IOException;
