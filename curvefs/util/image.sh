...
cp -f ../thirdparties/memcache/libmemcached-1.1.2/build-libmemcached/src/libmemcached/libmemcached.so.11 docker/$2
cp -f ../thirdparties/memcache/libmemcached-1.1.2/build-libmemcached/src/libhashkit/libhashkit.so.2 docker/$2
for file in `ls conf`;
do
    dsv="="
