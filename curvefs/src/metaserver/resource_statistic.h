...
#ifndef CURVEFS_SRC_METASERVER_RESOURCE_STATISTIC_H_
#define CURVEFS_SRC_METASERVER_RESOURCE_STATISTIC_H_
...
#endif  // CURVEFS_SRC_METASERVER_RESOURCE_STATISTIC_H_
