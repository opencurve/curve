...
#ifndef CURVEFS_SRC_METASERVER_COPYSET_META_OPERATOR_CLOSURE_H_
#define CURVEFS_SRC_METASERVER_COPYSET_META_OPERATOR_CLOSURE_H_
...
#endif  // CURVEFS_SRC_METASERVER_COPYSET_META_OPERATOR_CLOSURE_H_
