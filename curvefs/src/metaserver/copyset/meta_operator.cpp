...
OPERATOR_ON_APPLY(UpdateInodeS3Version);
...
OPERATOR_ON_APPLY_FROM_LOG(UpdateInodeS3Version);
...
OPERATOR_REDIRECT(UpdateInodeS3Version);
...
OPERATOR_ON_FAILED(UpdateInodeS3Version);
...
OPERATOR_HASH_CODE(UpdateInodeS3Version);
...
PARTITION_OPERATOR_HASH_CODE(DeletePartition);
...
OPERATOR_TYPE(UpdateInodeS3Version);
