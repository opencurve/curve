...
OPERATOR_ON_APPLY(AppendS3ChunkInfo);
...
OPERATOR_ON_APPLY_FROM_LOG(AppendS3ChunkInfo);
...
OPERATOR_REDIRECT(AppendS3ChunkInfo);
...
OPERATOR_ON_FAILED(AppendS3ChunkInfo);
...
OPERATOR_HASH_CODE(AppendS3ChunkInfo);
...
OPERATOR_TYPE(AppendS3ChunkInfo);
