...
#include "curvefs/src/space_allocator/fast_align.h"
...
void BitmapAllocator::DeAlloc(const uint64_t off, const uint64_t len) {
    std::lock_guard<bthread::Mutex> lock(mtx_);
...
void BitmapAllocator::DeAlloc(const Extents& exts) {
