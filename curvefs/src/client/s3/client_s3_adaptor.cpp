...
S3ClientAdaptorImpl::ReadKVRequest(const std::vector<S3ReadRequest> &kvRequests,
...
void S3ClientAdaptorImpl::ProcessKVRequest(const S3ReadRequest &req, char *dataBuf,
                                        uint64_t fileLen,
                                        std::once_flag &cancelFlag,
