...
uint32_t Permission::GetCurrentUid() {
    return userPerm_.uid;
}

uint32_t Permission::GetCurrentGid() {
    return userPerm_.gids[0];
}

uint32_t Permission::GetCurrentUmask() {
    return userPerm_.umask;
}
