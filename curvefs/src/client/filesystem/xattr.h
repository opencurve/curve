...
const char XATTR_DIR_FILEBYTES[] = "curve.dir.fbytes";
...
const char XATTR_WARMUP[] = "curvefs.warmup.op";

bool IsSpecialXAttr(const std::string& key) {
...
bool IsWarmupXAttr(const std::string& key) {
    return key == XATTR_WARMUP;
}
