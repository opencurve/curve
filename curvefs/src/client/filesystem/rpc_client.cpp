...
CURVEFS_ERROR RPCClient::Lookup(Ino parent, const std::string& name, DirEntry* out) {
    Dentry dentry;
    ...
    rc = inodeManager_->GetInodeAttr(ino, &out->attr);
    if (rc != CURVEFS_ERROR::OK) {
