...
int CurvefsBuildTopologyTool::InitMetaServerData() {
...
int CurvefsBuildTopologyTool::GetMetaServersInServer(
    ServerIdType serverid, std::list<MetaServerInfo>* metaserverInfos) {
    TopologyService_Stub stub(&channel_);
    ...
    LOG(INFO) << "ListMetaServer, send request: " << request.DebugString();
...
int CurvefsBuildTopologyTool::CreateMetaServer() {
    TopologyService_Stub stub(&channel_);
