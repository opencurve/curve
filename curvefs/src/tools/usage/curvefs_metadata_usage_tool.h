...
#ifndef CURVEFS_SRC_TOOLS_USAGE_CURVEFS_METADATA_USAGE_TOOL_H_
#define CURVEFS_SRC_TOOLS_USAGE_CURVEFS_METADATA_USAGE_TOOL_H_
...
class MatedataUsageTool
    : public CurvefsToolRpc<curvefs::mds::topology::StatMetadataUsageRequest,
...
#endif  // CURVEFS_SRC_TOOLS_USAGE_CURVEFS_METADATA_USAGE_TOOL_H_
