...
#include "curvefs/test/metaserver/mock_mds_client.h"
#include "curvefs/test/metaserver/mock_metaserver_s3_adaptor.h"

using ::curvefs::mds::FSStatusCode;
using ::curvefs::metaserver::mdsclient::MockMdsClient;
using ::testing::_;
...
TEST_F(PartitionCleanManagerTest, test1) {
    ...
    std::shared_ptr<mdsclient::MockMdsClient> mdsclient =
        std::make_shared<mdsclient::MockMdsClient>();
