...
#define TEST_SERVICE_OVERLOAD(TYPE)                                 \
    ...
    TEST_SERVICE_OVERLOAD(CreateManageInode);
    TEST_SERVICE_OVERLOAD(CreatePartition);
    TEST_SERVICE_OVERLOAD(DeletePartition);
    TEST_SERVICE_OVERLOAD(PrepareRenameTx);
    TEST_SERVICE_OVERLOAD(PrewriteRenameTx);
    TEST_SERVICE_OVERLOAD(CheckTxStatus);
    TEST_SERVICE_OVERLOAD(ResolveTxLock);
    TEST_SERVICE_OVERLOAD(CommitTx);
...
#define TEST_COPYSETNODE_NOTFOUND(TYPE)                                     \
    ...
    TEST_COPYSETNODE_NOTFOUND(CreateManageInode);
    ...
    TEST_COPYSETNODE_NOTFOUND(PrewriteRenameTx);
    TEST_COPYSETNODE_NOTFOUND(CheckTxStatus);
    TEST_COPYSETNODE_NOTFOUND(ResolveTxLock);
    TEST_COPYSETNODE_NOTFOUND(CommitTx);
