...
TEST_F(FSStorageTest, test1) {
    ...
    MdsFsInfo fs1(fsId, "name1", FsStatus::NEW, rootInodeId,
                            capacity, blockSize, volume);
    // test insert
    ...
    MdsFsInfo fs3(fsId, "name3", FsStatus::NEW, rootInodeId,
                            capacity, blockSize, volume);
    ASSERT_EQ(FSStatusCode::NOT_FOUND, storage.Update(fs3));
    MdsFsInfo fs4(fsId + 1, "name1", FsStatus::NEW, rootInodeId,
                            capacity, blockSize, volume);
