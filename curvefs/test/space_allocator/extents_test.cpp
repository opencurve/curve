...
TEST(ExtentTest, TestAsSmallAllocatorWithHint) {
    ...
    // right offset hint 2
    {
        ...
        std::vector<PExtent> expected = {{16 * kMiB, 2 * kMiB},
                                        {30 * kMiB, 2 * kMiB}};
    ...
    // right offset hint 3
    {
        ...
        std::vector<PExtent> expected = {{0 * kMiB, 2 * kMiB},
                                        {14 * kMiB, 2 * kMiB}};
        ASSERT_EQ(ext1, expected);
    ...
    // extents are fragment
    {
        ...
        std::vector<PExtent> expected = {
            {16 * kMiB, 1 * kMiB}, {18 * kMiB, 1 * kMiB}, {20 * kMiB, 1 * kMiB},
            {22 * kMiB, 1 * kMiB}, {24 * kMiB, 1 * kMiB}, {26 * kMiB, 1 * kMiB},
