 ...
 *  - If the source data is on S3, the 'location' format is uri@s3, where 'uri' is the actual address of the chunk object.
 *  - If the source data is on CurveFS, the 'location' format is /filename/chunkindex@cs.
 *
 ...
 * @param: correntSn   Used for modifying the 'correctedSn' when creating the clone chunk
 *
 * @return error code
 */
