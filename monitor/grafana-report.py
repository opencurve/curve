...
sender = 'Grafana<storage_mgm@163.com>'
to_address = ['storage-dev@hz.netease.com']
username = 'storage_mgm@163.com'
password = 'netease163' # SMTP授权码
...
clustername = '【CURVE】建德beta'
grafanauri = '10.198.136.131:3000'
reporteruri = '127.0.0.1:8686'
dashboardid = 'nj1Iq_2Wk'
apitoken = 'eyJrIjoiNXR1QkF3TnZCUXhJdGtDVmxia21MakFxS3dPczBVZDkiLCJuIjoicmVwb3J0IiwiaWQiOjF9'
