...
// class StorageClient { //TODO 单独抽象出一个接口
//  public:
//     StorageClient() {}
...
//         uint64_t *leaderOid) = 0;
    
//     virtual int LeaderObserve(
//         uint64_t leaderOid, const std::string &leaderName) = 0;

//     virtual int LeaderResign(uint64_t leaderOid, uint64_t timeoutMs) = 0;
// };
