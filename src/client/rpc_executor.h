...
#ifndef SRC_CLIENT_RPC_EXECUTOR_H_
#define SRC_CLIENT_RPC_EXECUTOR_H_
...
class RPCExecutorRetryPolicy {
 public:
    RPCExecutorRetryPolicy()
 ...
 private:
    ...
    int ExcuteTask(int mdsindex, uint64_t rpcTimeOutMS,
                   RPCExecutorRetryPolicy::RPCFunc task);
    /**
...
using RPCExcutorRetryPolicy = RPCExecutorRetryPolicy;

}  // namespace client
}  // namespace curve

#endif  // SRC_CLIENT_RPC_EXECUTOR_H_
