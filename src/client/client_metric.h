...
class MetricHelper {
 public:
     ...
     * @param: read is whether the current operation is a read or write
     * operation
     */
     ...
     * user for RPS calculation rps: receive request persecond, which is the
     * number of requests received by the current interface per second qps:
     * query request persecond, which is the number of requests processed by the
     * current interface per second eps: error request persecond, which is the
     * number of requests that make errors per second on the current interface
     ...
     *RPC interfaces, used for QPS and bps calculations
     * @param: fm is the metric pointer of the current file
     * @param: length is the current request size
     * @param: read is whether the current operation is a read or write
     *operation
