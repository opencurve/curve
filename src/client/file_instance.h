...
class CURVE_CACHELINE_ALIGNMENT FileInstance {
 public:
    ...
    /**
     * Initialize
     * @param: filename The filename used to initialize the iomanager's metric information.
     * @param: mdsclient The global mds client.
     * @param: userinfo User information.
     * @param: fileservicopt The configuration options for the fileclient.
     * @param: clientMetric Metric information to be collected on the client side.
     ...
     * @param: aioctx The I/O context for asynchronous read/write, which holds basic I/O information
     ...
     * @param: aioctx An asynchronous read/write IO context that stores basic IO information
     * @param: dataType type of user buffer
