...
namespace curve {
namespace client {
// SnapshotClient is the exit for peripheral snapshot systems to communicate
// with MDS and Chunkserver
class SnapshotClient {
 public:
    SnapshotClient();
    ~SnapshotClient() = default;
    /**
     * Initialization function, peripheral system directly passes in
     ...
     * @param: seq is the output parameter to obtain the version information of
     * the file
     ...
     * @param: seq corresponds to the version information when taking a snapshot
     * of the file
    ...
    /**
     * List the file information corresponding to the version list of the
     * current file
     * @param: userinfo is the user information
     * @param: filenam file name
     * @param: seqvec is the version list of the current file
     * @param: snapif is a parameter that obtains file information for multiple
     * seq numbers
     * @return: Successfully returned LIBCURVE_ERROR::OK, otherwise
     * LIBCURVE_ERROR::FAILED
     */
     ...
     * @param: segInfo is a parameter that saves the snapshot segment
     ...
     * If no snapshot is generated during the dump process, modify the correntSn
     * of the chunk
     * @param: cidinfo is the ID information corresponding to the current chunk
 ...
 private:
    // MDSClient is responsible for communicating with Metaserver, and all
    // communication goes through this interface
