...
class SnapshotTaskManager {
 ...
 private:
     ...
     * Check if the snapshot task has been completed; if completed, remove it from the work queue
     *
     */
 ...
 private:
    ...
    // Indicates whether the current task management is stopped, used to support start and stop functions.
