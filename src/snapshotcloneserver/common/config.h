...
struct SnapshotCloneServerOptions {
    ...
    // The number of asynchronous requests simultaneously processed by
    // ReadChunkSnapshot
    ...
    // Number of thread pool threads used for requests for non Lazy clones and
    // deletion of clones and other control surfaces
