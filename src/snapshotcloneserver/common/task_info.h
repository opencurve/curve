...
class TaskInfo {
 public:
     ...
     *  1. Before completing the task, first lock the task and then determine
     * whether the task is cancelled, If cancelled, release the lock, Otherwise,
     * release the lock after completing the logic of the task.
     *  2. Before canceling a task, first lock the task and then determine
     * whether the task is completed, If completed, release the lock, Otherwise,
     * execute the task to cancel the logic and release the lock.
     */
