...
#ifndef SRC_SNAPSHOTCLONESERVER_COMMON_S3_ADAPTER_H_
#define SRC_SNAPSHOTCLONESERVER_COMMON_S3_ADAPTER_H_
#include <map>
#include <string>
...
const Aws::String addr = "nos-eastchina1.126.net";
const Aws::String ak = "7e1a3a1823b24873b148db82315ae949";
const Aws::String sk = "1b2c0e91e3884275b73d3456368b590c";
const Aws::String bucket_name = "curve-snapshot";
namespace curve {
...
#endif  // SRC_SNAPSHOTCLONESERVER_COMMON_S3_ADAPTER_H_
