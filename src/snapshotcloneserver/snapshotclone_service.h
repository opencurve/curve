...
class SnapshotCloneServiceImpl : public SnapshotCloneService {
 public:
    ...
    SnapshotCloneServiceImpl(
        ...
        : snapshotManager_(snapshotManager), cloneManager_(cloneManager) {}
     ...
     */
    void default_method(RpcController* cntl, const HttpRequest* req,
                        HttpResponse* resp, Closure* done);
 ...
 private:
    ...
    void HandleCloneAction(brpc::Controller* bcntl,
                           const std::string& requestId, Closure* done);
    ...
    void HandleGetCloneRefStatusAction(brpc::Controller* bcntl,
                                       const std::string& requestId);
    bool CheckBoolParamter(const std::string* param, bool* valueOut);
