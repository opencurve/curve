...
#ifndef CURVE_SRC_MDS_SCHEDULE_OPERATOR_CONTROLLER_H_
#define CURVE_SRC_MDS_SCHEDULE_OPERATOR_CONTROLLER_H_
...
#endif  // CURVE_SRC_MDS_SCHEDULE_OPERATOR_CONTROLLER_H_
