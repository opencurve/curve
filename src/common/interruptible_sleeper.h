 ...
 * Under normal circumstances, when wait_for times out and receives an exit
 * signal, the program will be immediately awakened, exit the while loop, and
 * execute cleanup code.
 */
class InterruptibleSleeper {
 public:
    /**
     * @brief wait_for Wait for the specified time, and immediately return if an
