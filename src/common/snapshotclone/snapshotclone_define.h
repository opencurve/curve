...
// Error code: Cannot take a snapshot of files with abnormal snapshots, or
// cannot clone/recover target files with errors
...
// Error code: Cannot clone a snapshot that has never been completed or has
// errors
