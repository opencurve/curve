...
class ChunkServerClient {
 public:
    ...
    /**
     *  @brief: Call the RaftStat interface of Braft to obtain detailed
     *  information about the replication group, and place it in iobuf
    ...
    /**
     *  @brief: Check if the chunkserver is online, only check the controller,
     * not the response
