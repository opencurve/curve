...
class SegmentParser {
 public:
     ...
     */
    virtual bool SuccessfullyFinished() { return off_ >= fileLen_; }
...
class RaftLogTool : public CurveTool {
 ...
 private:
     ...
     * @param[out] head entry header information, valid when the return value is
     * 0
     * @return successfully returns 0, otherwise returns -1
     */
     ...
     * @param fileName raft log file name
     * @param[out] firstIndex The first index of the log entry contained in the
     * segment file
     * @return successfully returns 0, otherwise returns -1
     */
