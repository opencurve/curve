...
class StatusTool : public CurveTool {
 public:
    ...
    /**
     * @brief Determine whether the cluster is healthy
     */
 ...
 private:
    ...
    /**
     * @brief Determine whether the command needs to interact with etcd
     * @param command: The command to be executed
     * @return Returns true if interaction is needed, otherwise returns false
     */
    bool CommandNeedEtcd(const std::string& command);

    /**
     * @brief Determine if the command requires mds
     * @param command: The command executed
     * @return Returns true if mds is needed, otherwise returns false
     */
     ...
     * @param command: The command executed
     * @return Returns true if snapshot clone server is needed, otherwise
     *         returns false
     */
 ...
 private:
    ...
    // Copyset checking tool, used to check the health status of clusters and
    // chunkservers
