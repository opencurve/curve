...
// Using the implementation of LatencyRecorder to count the size of read and
// write requests Statistics can be conducted on quantile values, maximum
// values, median values, mean values, and other factors
...
class CSIOMetric {
 public:
     ...
     * @param type: The corresponding metric type of the request
     * @return returns the IOMetric pointer corresponding to the specified type,
     * or nullptr if the type does not exist
     */
...
class CSCopysetMetric {
 public:
     ...
     * @param logicPoolId: The ID of the logical pool to which the copyset
     * belongs
    ...
    /**
     * Monitor DataStore indicators, mainly including the number of chunks,
     * number of snapshots, etc
...
class ChunkServerMetric : public Uncopyable {
 public:
     ...
     * @param logicPoolId: The logical pool ID where this io operation is
     * located
     ...
     *belongs
     * @param copysetId: The ID of the copyset
     * @return returns 0 for success, -1 for failure, or failure if the
     ...
     * belongs
     * @param copysetId: The ID of the copyset
     * @return successfully returns the specified copyset metric, while failure
     * returns nullptr
     */
    ...
    /**
     *Monitor the chunk allocation pool, mainly monitoring the number of chunks
     *in the pool
    ...
    /**
     *Monitor the allocation pool of wall segments, mainly monitoring the number
