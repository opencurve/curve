...
/**
 * Snapshot attachment file metadata table, similar to the above
 * CurveSnapshotAttachMetaTable interface. This table primarily provides
 * interfaces for querying, serializing, and deserializing attachment file
 * metadata
 */
...
class CurveSnapshotFileReader : public braft::LocalDirReader {
 public:
    ...
    braft::LocalSnapshotMetaTable get_meta_table() { return _meta_table; }
