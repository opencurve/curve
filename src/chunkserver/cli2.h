...
/**
 * Cli is the encapsulation of the interface related to configuration changes
 * for ease of use and to avoid direct RPC manipulation
 */
...
// Trigger snapshots for all copyset copies on the chunkserver
