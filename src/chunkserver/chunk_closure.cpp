...
void ChunkClosure::Run() {
    ...
    /**
     *Although before the request proposal was given to the copyset
     *Confirmed the identity of the leader, but processed it in copyset
     *When requesting, it is still possible to determine the identity of the current copyset
     *Becoming a non leader, so it needs to be determined that ChunkClosure has been adjusted
     *When using, the status of the request. If it is OK, it indicates that it is
     *Normal apply processing, otherwise the request will be forwarded
     */
