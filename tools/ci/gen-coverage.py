...
def main(args):
  run([lcov, '--directory', "nebd/src", '--directory', 'src/', '--directory', 'curvefs/src', '--capture', '-o', cov_post_raw] + brflag )
  run([lcov, '--directory', "nebd/src", '--directory', 'src/', '--directory', 'curvefs/src', '--capture', '--initial', '-o', cov_init_raw])
