...
So far, we have implemented a high performance block storage system, which supports snapshot, clone and recovery, and can be mounted by QEMU and NBD devices. CURVE has been served as a cloud disk inside NetEase for a certain time, during which high performance and reliability have shown.
...
- [Github Issues](https://github.com/openCURVE/CURVE/issues)：You are sincerely welcomed to upload any bugs you came across or any suggestions through Github issues. If you have any question you can refer to our FAQ or join our user group for more details.
