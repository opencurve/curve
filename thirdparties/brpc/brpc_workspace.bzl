...
def brpc_workspace():
    ...
    http_archive(
        ...
        build_file = "//thirdparties/brpc:protobuf.BUILD",
        patch_cmds = [
    ...
    http_archive(
        ...
        build_file = "//thirdparties/brpc:leveldb.BUILD",
    ...
    http_archive(
        ...
        build_file = "//thirdparties/brpc:zlib.BUILD",
    ...
    native.new_local_repository(
        name = "openssl",
        path = "/usr",
        build_file = "//thirdparties/brpc:openssl.BUILD",
    )
