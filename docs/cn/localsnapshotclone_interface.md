# localsnapshotclone interface

本地快照和克隆接口采用tools-v2工具命令行的方式实现，具体使用方法如下：
...
Examples:
$ curve bs create snapshot --path /test --user curve
```
...
Examples:
$ curve bs delete snapshot --snappath /test0/test0-1 --user curve
$ curve bs delete snapshot --path /test0 --seq 1 --user curve
```
...
Examples:
$ curve bs list snapshot --path / --user curve
```
...
Examples:
$ curve bs protect --snappath /test1/test1-1 --user curve
$ curve bs protect --path /test1 --seq 1 --user curve
```
...
Examples:
$ curve bs unprotect --snappath /test1/test1-1 --user curve
$ curve bs unprotect --path /test1 --seq 1 --user curve
```
...
Examples:
$ curve bs children --path /test1 --user curve
...
Examples:
$ curve bs clone --snappath /test1/test1-1 --dstpath /test2 --user curve
