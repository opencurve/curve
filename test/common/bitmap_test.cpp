...
TEST(BitmapTEST, divide_test) {
    ...
    //Three ranges, with set ranges at the beginning and end, and clear ranges in the middle
    {
        bitmap.Set(0, 8);
        bitmap.Clear(9, 25);
        bitmap.Set(26, 31);
    ...
    //Three ranges, with clear ranges at the beginning and end, and set ranges in the middle
    {
        bitmap.Clear(0, 8);
        bitmap.Set(9, 25);
        bitmap.Clear(26, 31);
