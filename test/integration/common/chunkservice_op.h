...
class ChunkServiceOp {
 public:
     ...
     * legacy through chunkService If no snapshot is generated during the dump
     * process, modify the correctedSn of the chunk
     * @param opConf Common configuration parameters such as,
     * leaderPeer/copyset, etc
     * @param chunkId
     * @param correctedSn
...
class ChunkServiceVerify {
 public:
     ...
     * matches the expected data in the corresponding region of the chunkdata.
     * @param chunkId
     * @param sn chunk version
     * @param offset
     * @param len
     ...
     *And verify whether the read content matches the expected data in the
     *corresponding area of chunkdata.
     * @param chunkId
     * @param sn chunk version
     * @param offset
     * @param len
