...
class CSCloneRecoverTest : public ::testing::Test {
 public:
    ...
    /** Send a read request and wait for completion
     * @param: offset is the offset that currently requires issuing IO
     * @param: size is the size of the issued IO
     * @data: Read out data
     * @return: Is IO successfully completed
...
TEST_F(CSCloneRecoverTest, CloneFromCurveByReadChunk) {
    ...
    /**
     * Clone files will not be converted to regular chunk1 files after being
     * read through Write by increasing the version, If it is a clone chunk, the
     * write will fail; If it is a regular chunk, a snapshot file will be
     * generated.
     */
    ASSERT_EQ(0,
              verify.VerifyGetChunkInfo(cloneChunk1, sn1, NULL_SN, string("")));
...
TEST_F(CSCloneRecoverTest, CloneFromCurveByRecoverChunk) {
     ...
     * If it is a clone chunk, the write will fail; If it is a regular chunk, a
     * snapshot file will be generated and successfully written.
     */
    ASSERT_EQ(0,
              verify.VerifyGetChunkInfo(cloneChunk1, sn1, NULL_SN, string("")));
...
TEST_F(CSCloneRecoverTest, CloneFromCurveByReadChunkWhenLazyAlloc) {
    ...
    /**
     * The clone file will be converted to a regular chunk1 file after being
     * overwritten Write by increasing the version, If it is a clone chunk, the
     * write will fail; If it is a regular chunk, a snapshot file will be
     * generated.
     */
    ASSERT_EQ(0,
...
TEST_F(CSCloneRecoverTest, CloneFromS3ByReadChunk) {
    ...
    /**
     * It is expected that the clone file will not be converted to a regular
     * chunk1 file after being read through Write by increasing the version, If
     * it is a clone chunk, the write will fail; If it is a regular chunk, a
     * snapshot file will be generated.
     */
    ASSERT_EQ(0,
              verify.VerifyGetChunkInfo(cloneChunk1, sn1, NULL_SN, string("")));
    ASSERT_EQ(CHUNK_OP_STATUS_FAILURE_UNKNOWN,
