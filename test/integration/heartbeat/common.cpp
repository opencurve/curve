...
void HeartbeatIntegrationCommon::PrepareAddPoolset(const Poolset& poolset) {
...
void HeartbeatIntegrationCommon::PrepareBasicCluseter() {
    ...
    // add poolset
    PoolsetIdType poolsetId = 2;
    Poolset poolset(poolsetId, "testPoolset", "SSD", "descPoolset");
...
void HeartbeatIntegrationCommon::BuildBasicCluster() {
    ...
    auto topologyStorage = std::make_shared<topology::FakeTopologyStorage>();
    topology_ =
