...
//Reboot during the Create CloneFile phase, no files were created on the mds
...
//Reboot during the Create CloneFile phase, successful file creation on mds but not returned
TEST_F(SnapshotCloneServerTest,
...
//Reboot during the Create CloneMeta phase, no segment was created on mds
...
//Reboot during the Create CloneMeta phase, successfully creating segment on mds but not returning
TEST_F(SnapshotCloneServerTest,
...
//Reboot during the Create CloneChunk phase, cloneChunk not created on chunkserver
...
//Restart the Create Clone Chunk phase and create a partial clone chunk on the chunkserver
TEST_F(SnapshotCloneServerTest,
