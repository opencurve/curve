...
class CurveCluster {
 public:
    /**
     * @brief CurveCluster constructor
     *
    ...
    /**
     * @brief InitMdsClient, initializes mdsclient for interaction with mds
     *
    ...
    /**
     * @brief BuildNetWork, If BuildNet needs to use a different IP to start the
     * chunkserver, This function needs to be called first in the SetUp of the
     * test case
     *
     * @return 0 Success; Non 0 Failure
     */
    ...
    /**
     * @brief StopCluster, stops all processes in the cluster
     *
    ...
    /**
     * @brief StartSingleMDS starts an mds
    ...
    /**
     * @brief StopMDS, stops the specified id's mds
     * @return 0.Success; -1.Failure
     */
    int StopMDS(int id);

    /**
     * @brief StopAllMDS, stops all mds
     * @return 0.Success; -1.Failure
     */
    int StopAllMDS();
    ...
    /**
     * @brief StartSingleEtcd starts an etcd node
     *
     * @param clientIpPort
     * @param peerIpPort
    ...
    /**
     * @brief WaitForEtcdClusterAvalible
    ...
    /**
     * @brief StopEtcd stops the etcd node with the specified id
     * @return 0.Success; -1.Failure
     */
    int StopEtcd(int id);

    /**
     * @brief StopAllEtcd stops all etcd nodes
     * @return 0.Success; -1.Failure
     */
    int StopAllEtcd();

    /**
     * @brief FormatFilePool, Format FilePool
     *
    ...
    /**
     * @brief StartSingleChunkServer starts a chunkserver node
     *
     * @param[in] id
     * @param[in] ipPort
     ...
     *  const std::vector<std::string> chunkserverConf1{
        ...
        file name. The file name should not be too long, otherwise registering
    ...
    /**
     * @brief StartSingleChunkServer Starts a chunkserver with the specified id
     * in the network namespace No need to specify ipPort
     *
     * @param id
    ...
    /**
     * @brief StopChunkServer stops the chunkserver process with the specified
     * id
     * @return 0.Success; -1.Failure
     */
    ...
    /**
     * @brief StopAllChunkServer Stop all chunkserver
     * @return 0.Success; -1.Failure
     */
    int StopAllChunkServer();

    /**
     * @brief PreparePhysicalPool Create Physical Pool
     *
    ...
    /**
     * @brief HangMDS hang resides in the specified mds process
     * @return 0.Success; -1.Failure
     */
    int HangMDS(int id);

    /**
     * @brief RecoverHangMDS restores the mds process where hang resides
     * @return 0.Success; -1.Failure
     */
    int RecoverHangMDS(int id);

    /**
     * @brief HangEtcd hang lives in the specified etcd process
     * @return 0.Success; -1.Failure
     */
    int HangEtcd(int id);

    /**
     * @brief RecoverHangEtcd recovers the mds process where hang resides
     * @return 0.Success; -1.Failure
     */
    int RecoverHangEtcd(int id);

    /**
     * @brief HangChunkServer hang resides in the specified chunkserver process
     * @return 0.Success; -1.Failure
     */
    int HangChunkServer(int id);

    /**
     * @brief RecoverHangChunkServer Restores the chunkserver process where hang
     * resides
     * @return 0.Success; -1.Failure
     */
     ...
     *
     * @param[out] curId: the currently serving the mds number
     *
    ...
    /**
     * @brief CreateFile creates a file in Curve.
     *
     * @param[in] user: User
 ...
 private:
    /**
     * @brief ProbePort checks if the specified ipPort is in a listening state.
     *
    ...
    /**
     * @brief ChunkServerIpPortInBackground
    ...
    /**
     * @brief HangProcess hang a process
     *
    ...
    /**
     * @brief RecoverHangProcess recovers a hung process.
     *
     * @param pid: Process ID
     * @return 0. Success; -1. Failure
     */
