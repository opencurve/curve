...
TEST_F(TestEtcdClinetImp, test_CampaignLeader) {
    ...
    {
        //1 Leader 1 successfully ran, but leader 2 successfully ran after client exited
        ...
        common::Thread thread2(&EtcdClientImp::CampaignLeader, client2, pfx,
                               ...
                               &leaderOid);
        //After thread 1 exits, leader2 will be elected
        thread2.join();
    ...
    {
        //2 After the successful election of leader 1, do not withdraw; Leader 2 campaign timeout
    ...
    {
        //3 After the successful election of leader 1, delete the key; The leader 2 campaign was successful; Observe leader1 changed;
        //During the process of observer leader 2, etcd crashes
        ...
        //Leader 2 starts thread observe
...
TEST_F(TestEtcdClinetImp, test_ListSegment) {
    ...
    //Place the segment, with the first three belonging to file 1 and the last four belonging to file 2
    uint64_t id1 = 101;
    uint64_t id2 = 100001;
