...
TEST_F(HeartbeatTest, TransferLeader) {
    ...
    // Construct the expected CopySetInfo for req, with the expectleader being dst1
    ...
    // Construct the expected CopySetInfo for req, with the expectleader being dst2
    peer = new ::curve::common::Peer();
