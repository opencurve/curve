...
TEST_P(OpRequestTest, ReadChunkTest) {
    ...
    /**
     * Test OnApply
     * Scenario: The requested chunk is a clone chunk, and the bitmaps in the request area are all 1
     * Expected: Chunk read locally, returning CHUNK_OP_STATUS_SUCCESS
     */
    {
        // Reset closure
    ...
    /**
     * Test OnApply
     * Scenario: The requested chunk is a clone chunk, and the bitmap in the request area has a bit of 0
