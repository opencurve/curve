...
/*
 *The documentation for using libfiu can be found at: https://blitiri.com.ar/p/libfiu/doc/man-libfiu.html
 *Divided into two parts, one part is the core API, including FIU_ Do_ On/fiu_ Return_ On/fiu_ Init
 *The core API is used to act and inject into business code, and is controlled and triggered by external control APIs.
 *The control API includes: fiu_enable\fiu_disable\fiu_enable_random, etc
 *Used for user error injection at the testing code, the specific usage and method are shown in the example code below
 */
