...
TEST_F(StatusToolTest, ChunkServerCmd) {
    ...
    //Under normal circumstances, there is a chunkserver with an UnhealthyRatio greater than 0
    ...
    //when FLAGS_checkCSAlive is true, an rpc will be sent to check the online status of the chunkserver
