...
#ifndef TEST_MDS_NAMESERVER2_MOCK_CHUNK_ID_GENERATOR_H_
#define TEST_MDS_NAMESERVER2_MOCK_CHUNK_ID_GENERATOR_H_
...
#endif  // TEST_MDS_NAMESERVER2_MOCK_CHUNK_ID_GENERATOR_H_
