...
class MockIdGenerator : public TopologyIdGenerator {
 public:
    ...
    MOCK_METHOD1(initLogicalPoolIdGenerator, void(PoolIdType idMax));
    MOCK_METHOD1(initPhysicalPoolIdGenerator, void(PoolIdType idMax));
    MOCK_METHOD1(initZoneIdGenerator, void(ZoneIdType idMax));
    MOCK_METHOD1(initServerIdGenerator, void(ServerIdType idMax));
    MOCK_METHOD1(initChunkServerIdGenerator, void(ChunkServerIdType idMax));
    MOCK_METHOD1(initCopySetIdGenerator, void(const std::map<PoolIdType, CopySetIdType> &idMaxMap));
    ...
    MOCK_METHOD1(GenCopySetId, CopySetIdType(PoolIdType logicalPoolId));
...
class MockStorage : public TopologyStorage {
 public:
    ...
    MOCK_METHOD4(init, bool(const std::string &dbName,
        const std::string &user,
        const std::string &url,
        const std::string &password));

    MOCK_METHOD2(LoadLogicalPool, bool(std::unordered_map<PoolIdType, LogicalPool> *logicalPoolMap, PoolIdType *maxLogicalPoolId));
    MOCK_METHOD2(LoadPhysicalPool, bool(std::unordered_map<PoolIdType, PhysicalPool> *physicalPoolMap, PoolIdType *maxPhysicalPoolId));
    MOCK_METHOD2(LoadZone, bool(std::unordered_map<ZoneIdType, Zone> *zoneMap, ZoneIdType *maxZoneId));
    MOCK_METHOD2(LoadServer, bool(std::unordered_map<ServerIdType, Server> *serverMap, ServerIdType *maxServerId));
    MOCK_METHOD2(LoadChunkServer, bool(std::unordered_map<ChunkServerIdType, ChunkServer> *chunkServerMap, ChunkServerIdType *maxChunkServerId));
    MOCK_METHOD2(LoadCopySet, bool(std::map<CopySetKey, CopySetInfo> *copySetMap, std::map<PoolIdType, CopySetIdType> *copySetIdMaxMap));

    MOCK_METHOD1(StorageLogicalPool, bool(const LogicalPool &data));
    MOCK_METHOD1(StoragePhysicalPool, bool(const PhysicalPool &data));
    MOCK_METHOD1(StorageZone, bool(const Zone &data));
    MOCK_METHOD1(StorageServer, bool(const Server &data));
    MOCK_METHOD1(StorageChunkServer, bool(const ChunkServer &data));
    MOCK_METHOD1(StorageCopySet, bool(const CopySetInfo &data));

    MOCK_METHOD1(DeleteLogicalPool, bool(PoolIdType id));
    MOCK_METHOD1(DeletePhysicalPool, bool(PoolIdType id));
    MOCK_METHOD1(DeleteZone, bool(ZoneIdType id));
    MOCK_METHOD1(DeleteServer, bool(ServerIdType id));
    MOCK_METHOD1(DeleteChunkServer, bool(ChunkServerIdType id));
    MOCK_METHOD1(DeleteCopySet, bool(CopySetKey key));

    MOCK_METHOD1(UpdateLogicalPool, bool(const LogicalPool &data));
    MOCK_METHOD1(UpdatePhysicalPool, bool(const PhysicalPool &data));
    MOCK_METHOD1(UpdateZone, bool(const Zone &data));
    MOCK_METHOD1(UpdateServer, bool(const Server &data));
    MOCK_METHOD1(UpdateChunkServer, bool(const ChunkServer &data));
...
class MockTopologyServiceManager : public TopologyServiceManager {
 public:
    ...
    MOCK_METHOD2(RegistChunkServer, void(const ChunkServerRegistRequest* request,
                      ChunkServerRegistResponse* response));

    MOCK_METHOD2(ListChunkServer, void(const ListChunkServerRequest* request,
                      ListChunkServerResponse* response));

    MOCK_METHOD2(GetChunkServer, void(const GetChunkServerInfoRequest* request,
                      GetChunkServerInfoResponse* response));

    MOCK_METHOD2(DeleteChunkServer, void(const DeleteChunkServerRequest* request,
                      DeleteChunkServerResponse* response));

    MOCK_METHOD2(SetChunkServer, void(const SetChunkServerStatusRequest* request,
    ...
    MOCK_METHOD2(CreateZone, void(const ZoneRequest* request,
                      ZoneResponse* response));

    MOCK_METHOD2(DeleteZone, void(const ZoneRequest* request,
                      ZoneResponse* response));

    MOCK_METHOD2(GetZone, void(const ZoneRequest* request,
                      ZoneResponse* response));

    MOCK_METHOD2(ListPoolZone, void(const ListPoolZoneRequest* request,
                      ListPoolZoneResponse* response));

    MOCK_METHOD2(CreatePhysicalPool, void(const PhysicalPoolRequest* request,
                      PhysicalPoolResponse* response));

    MOCK_METHOD2(DeletePhysicalPool, void(const PhysicalPoolRequest* request,
                      PhysicalPoolResponse* response));

    MOCK_METHOD2(GetPhysicalPool, void(const PhysicalPoolRequest* request,
                      PhysicalPoolResponse* response));

    MOCK_METHOD2(ListPhysicalPool, void(const ListPhysicalPoolRequest* request,
                      ListPhysicalPoolResponse* response));

    MOCK_METHOD2(CreateLogicalPool, void(const CreateLogicalPoolRequest* request,
                      CreateLogicalPoolResponse* response));

    MOCK_METHOD2(DeleteLogicalPool, void(const DeleteLogicalPoolRequest* request,
                      DeleteLogicalPoolResponse* response));

    MOCK_METHOD2(GetLogicalPool, void(const GetLogicalPoolRequest* request,
                      GetLogicalPoolResponse* response));

    MOCK_METHOD2(ListLogicalPool, void(const ListLogicalPoolRequest* request,
...
class MockRepo : public Repo {
 public:
    ...
    MOCK_METHOD4(connectDB, int(const std::string &dbName,
                                const std::string &user,
                                const std::string &url,
                                const std::string &password));
    ...
    MOCK_METHOD1(InsertChunkServerRepo,
        int(const ChunkServerRepo &cr));

    MOCK_METHOD1(LoadChunkServerRepos,
        int(std::vector<ChunkServerRepo> *chunkServerRepoList));

    MOCK_METHOD1(DeleteChunkServerRepo,
        int(ChunkServerIDType id));

    MOCK_METHOD1(UpdateChunkServerRepo,
        int(const ChunkServerRepo &cr));

    MOCK_METHOD2(QueryChunkServerRepo,
        int(ChunkServerIDType id, ChunkServerRepo *repo));

    MOCK_METHOD1(InsertServerRepo,
        int(const ServerRepo &sr));

    MOCK_METHOD1(LoadServerRepos,
        int(std::vector<ServerRepo> *serverList));
    ...
    MOCK_METHOD2(QueryServerRepo,
        int(ServerIDType id, ServerRepo *repo));

    MOCK_METHOD1(InsertZoneRepo,
        int(const ZoneRepo &zr));

    MOCK_METHOD1(LoadZoneRepos,
        int(std::vector<ZoneRepo> *zonevector));
