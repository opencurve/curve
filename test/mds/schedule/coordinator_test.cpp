...
TEST(CoordinatorTest, test_copySet_heartbeat) {
    ...
    ::curve::mds::heartbeat::CopySetConf res;
    {
        ...
        ASSERT_TRUE(UNINTIALIZE_ID == coordinator->CopySetHeartbeat(
