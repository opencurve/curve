...
class FakeChunkServiceImpl : public ChunkService {
 ...
 private:
    ...
    /* Due to the limitations of the bthread stack space, there will not be a
     * large amount of space opened here. If testing requires more space Please
     * apply on the pile*/
    char chunk_[4096] = {0};
};
 ...
 public:
    ...
    MOCK_METHOD4(ReadChunk,
                 void(::google::protobuf::RpcController* controller,
                      ...
                      ::curve::chunkserver::ChunkResponse* response,
                      google::protobuf::Closure* done));
    MOCK_METHOD4(ReadChunkSnapshot,
                 void(::google::protobuf::RpcController* controller,
                      const ::curve::chunkserver::ChunkRequest* request,
                      ::curve::chunkserver::ChunkResponse* response,
                      google::protobuf::Closure* done));
    ...
    void DelegateToFake() {
        ON_CALL(*this, WriteChunk(_, _, _, _))
            .WillByDefault(
                Invoke(&fakeChunkService, &FakeChunkServiceImpl::WriteChunk));
        ON_CALL(*this, ReadChunk(_, _, _, _))
            .WillByDefault(
                Invoke(&fakeChunkService, &FakeChunkServiceImpl::ReadChunk));
    }
