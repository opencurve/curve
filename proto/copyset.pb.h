...
#ifndef PROTOBUF_INCLUDED_copyset_2eproto
#define PROTOBUF_INCLUDED_copyset_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_copyset_2eproto 
...
class CopysetRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:curve.chunkserver.CopysetRequest) */ {
 ...
 private:
  ...
  friend struct ::protobuf_copyset_2eproto::TableStruct;
};
// -------------------------------------------------------------------
...
#endif  // PROTOBUF_INCLUDED_copyset_2eproto
