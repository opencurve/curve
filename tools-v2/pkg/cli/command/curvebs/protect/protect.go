...
const (
	dirExample = `$ curve bs protect --snappath /test1/test1-1 --user curve
...
func (fCmd *protectCommand) Init(cmd *cobra.Command, args []string) error {
    ...
    var request *nameserver2.ProtectSnapShotRequest
...
func (fCmd *protectCommand) RunCommand(cmd *cobra.Command, args []string) error {
    ...
    fCmd.Error = cmderror.ErrBsProtectSnapShot(fCmd.Response.GetStatusCode(), fCmd.Rpc.Request.GetFileName())
