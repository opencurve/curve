...
const (
	cloneRecoverExample = `$ curve bs delete volume clone-recover`
)
...
var _ basecmd.FinalCurveCmdFunc = (*CloneRecoverCmd)(nil)

func (rCmd *CloneRecoverCmd) Init(cmd *cobra.Command, args []string) error {
...
func (rCmd *CloneRecoverCmd) RunCommand(cmd *cobra.Command, args []string) error {
...
func (rCmd *CloneRecoverCmd) Print(cmd *cobra.Command, args []string) error {
	return output.FinalCmdOutput(&rCmd.FinalCurveCmd, rCmd)
}

func (rCmd *CloneRecoverCmd) ResultPlainOutput() error {
	return output.FinalCmdOutputPlain(&rCmd.FinalCurveCmd)
}

func (rCmd *CloneRecoverCmd) AddFlags() {
...
func NewDeleteVolumeCloneCommand() *CloneRecoverCmd {
	rCmd := &CloneRecoverCmd{
		FinalCurveCmd: basecmd.FinalCurveCmd{
			Use:     "clone",
			Short:   "delete volume clone-recover tasks in curvebs cluster",
