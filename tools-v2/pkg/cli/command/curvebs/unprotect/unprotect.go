...
const (
	dirExample = `$ curve bs unprotect --snappath /test1/test1-1 --user curve
...
func (fCmd *unprotectCommand) Init(cmd *cobra.Command, args []string) error {
    ...
    var request *nameserver2.UnprotectSnapShotRequest
...
func (fCmd *unprotectCommand) RunCommand(cmd *cobra.Command, args []string) error {
    ...
    fCmd.Error = cmderror.ErrBsUnprotectSnapShot(fCmd.Response.GetStatusCode(), fCmd.Rpc.Request.GetFileName())
