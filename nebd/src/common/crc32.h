...
/**
 * Calculate the CRC32 checksum (CRC32C) of the data and encapsulate it based on
 * the crc32 library of brpc
...
/**
 * Calculate the CRC32 checksum (CRC32C) of the data and encapsulate it based on
 * the crc32 library of brpc This function supports inheritance Calculate to
 * support the calculation of a single CRC checksum for SGL type data. Meet the
 * following constraints: CRC32("hello world", 11) == CRC32(CRC32("hello ", 6),
 * "world", 5)
