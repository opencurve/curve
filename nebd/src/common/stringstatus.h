...
class StringStatus {
 public:
    ...
    /**
     * @brief Update sets the key value pairs in the current key value map to status as JSON strings// NOLINT
     */
    void Update();
    ...
    /**
     * @brief JsonBody obtains the JSON format string corresponding to the current key value map
     */
    std::string JsonBody();
